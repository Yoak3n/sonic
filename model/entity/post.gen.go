...
type Post struct {
	...
	CreateTime      time.Time         `gorm:"column:create_time;not null;index:post_create_time,priority:1" json:"create_time"`
	UpdateTime      *time.Time        `gorm:"column:update_time" json:"update_time"`
	DisallowComment bool              `gorm:"column:disallow_comment;not null" json:"disallow_comment"`
	...
	FormatContent   string            `gorm:"column:format_content;not null" json:"format_content"`
	...
	OriginalContent string            `gorm:"column:original_content;not null" json:"original_content"`
	...
	Visits          int64             `gorm:"column:visits;not null" json:"visits"`
